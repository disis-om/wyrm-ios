...
The official iOS port of Wyrm. Phase 1 proved a UIKit + SwiftUI shell, SDL3 initialization, and a Vulkan clear frame presented through MoltenVK to a UIKit-owned `CAMetalLayer` in the Appetize simulator. Phase 2 is in progress: original engine assets are bundled and verified, but the real Wyrm snake is not rendered yet.
