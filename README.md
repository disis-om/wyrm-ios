...
**0.11.1 (build 35)** and targets **iOS 15 or newer**.
...
- `Wyrm-0.11.1-build-35-unsigned.ipa` for user-side signing and installation.
- `Wyrm-0.11.1-build-35-simulator.app.zip` for Simulator/Appetize testing.
