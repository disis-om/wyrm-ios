...
**0.17.4 (build 60)** and targets **iOS 15 or newer**.
...
- `Wyrm-0.17.4-build-60-unsigned.ipa` for user-side signing and installation.
- `Wyrm-0.17.4-build-60-simulator.app.zip` for Simulator/Appetize testing.
