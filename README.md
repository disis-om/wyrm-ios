...
**0.16.2 (build 47)** and targets **iOS 15 or newer**.
...
- `Wyrm-0.16.2-build-47-unsigned.ipa` for user-side signing and installation.
- `Wyrm-0.16.2-build-47-simulator.app.zip` for Simulator/Appetize testing.
