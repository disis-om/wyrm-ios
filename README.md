...
**0.11.2 (build 36)** and targets **iOS 15 or newer**.
...
- `Wyrm-0.11.2-build-36-unsigned.ipa` for user-side signing and installation.
- `Wyrm-0.11.2-build-36-simulator.app.zip` for Simulator/Appetize testing.
